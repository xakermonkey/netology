package com.grin.poligon.questionnaire.data;
...
import static com.grin.poligon.questionnaire.data.Options.CHECKBOX;
import static com.grin.poligon.questionnaire.data.Options.RADIOBUTTON;
...
public class QuestionSet {
    ...
    public static ArrayList<Question> getAllQuestions(Context context) {
        ...
        Question question1 = new Question("Профилирующий предмет", CHECKBOX, context.getResources().getStringArray(R.array.q1_options), Collections.singletonList(0));
        questions.add(question1);

        Question question2 = new Question("Ваше хобби", Options.EDITTEXT, context.getString(R.string.q3_answer));
        questions.add(question2);

        Question question3 = new Question("Желаемая профессия", CHECKBOX, context.getResources().getStringArray(R.array.q2_options), Arrays.asList(0, 1));
