package com.grin.poligon.questionnaire.utils;
...
public class ResultsAdapter extends RecyclerView.Adapter<ResultsAdapter.CardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        if (correctAnswers[position]) {
            holder.userAnswerTextView.setTextColor(ContextCompat.getColor(context, R.color.green_l));
        } else {
            holder.userAnswerTextView.setTextColor(ContextCompat.getColor(context, R.color.red_l));
        }
    }
